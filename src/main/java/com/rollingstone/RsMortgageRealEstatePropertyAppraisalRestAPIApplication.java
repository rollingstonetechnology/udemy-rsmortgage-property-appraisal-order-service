...
@EnableFeignClients
public class RsMortgageRealEstatePropertyAppraisalRestAPIApplication extends SpringBootServletInitializer {

    private static final Class<RsMortgageRealEstatePropertyAppraisalRestAPIApplication> applicationClass = RsMortgageRealEstatePropertyAppraisalRestAPIApplication.class;
